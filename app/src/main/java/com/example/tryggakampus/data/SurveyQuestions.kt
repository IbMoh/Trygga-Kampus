...
object SurveyQuestions {
    val questions = listOf(
        ...
        "Have you ever felt pressured to use drugs or alcohol to fit in with your peers?",
        "Have you ever felt pressured to use drugs or alcohol to fit in with your peers?",
        "Do you feel that substance use is normalized in your university environment?",
